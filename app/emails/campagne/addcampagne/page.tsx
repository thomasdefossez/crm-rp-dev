    ...
    const handleAddRecipients = async (newRecipients: Recipient[]) => {
        ...
        for (const recipient of newRecipients) {
            if (recipient.type === 'List') {
                ...
                if (error) {
                    console.error("Erreur Supabase lors de la récupération des contacts :", {
                      listId: recipient.id,
                      listName: recipient.name,
                      error,
                    });
                    toast.error(`Erreur lors de la récupération des contacts pour la liste "${recipient.name}".`);
                    continue;
                }
                ...
                <div className="flex gap-2">
                    ...
                    {currentStep === 2 && (
                        <div className="flex gap-2">
                            ...
                            <Button
                                variant="ghost"
                                className="border p-2 rounded-full bg-purple-600 hover:bg-purple-700 text-white"
            ...
            {currentStep === 3 && (
                <div className="flex flex-1">
                    ...
                    <div className="w-[60%] border-r p-8 space-y-4 overflow-y-auto max-h-[calc(100vh-100px)]">
                        ...
                        {/* Bouton texte d'aperçu + titre interne */}
